import { r as resolve, a as relative } from './index2.mjs';
...
import { d as defineNuxtCommand, c as consola, s as showBanner } from './index.mjs';
import { c as createServer, a as createLoadingHandler } from './server.mjs';
  ...
  async invoke(args) {
    ...
    const load = async (isRestart, reason) => {
      try {
        ...
        server.setApp(createLoadingHandler("Error while loading nuxt. Please check console and fix errors."));
      }
    };
    ...
    watcher.on("all", (event, file) => {
      ...
      if (file.startsWith(currentNuxt.options.buildDir)) {
        return;
      }
      ...
      if (isDirChange) {
        const dir = reloadDirs.find((dir2) => file.endsWith(dir2));
        if (dir) {
