...
import { i as isexe_1, o as onExit } from './index4.mjs';
...
function npmRunPath(options = {}) {
	...
	let previous;
	let cwdPath = path$3.resolve(cwd);
	const result = [];
	...
	result.push(path$3.resolve(cwd, execPath, '..'));
...
const handleArguments = (file, args, options = {}) => {
	...
	if (process$1.platform === 'win32' && path$3.basename(file, '.exe') === 'cmd') {
		// #116
		args.unshift('/q');
	}
