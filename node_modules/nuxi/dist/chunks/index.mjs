...
const commands = {
  dev: () => import('./dev.mjs').then(_rDefault),
  build: () => import('./build.mjs').then(_rDefault),
  preview: () => import('./preview.mjs').then(_rDefault),
  start: () => import('./preview.mjs').then(_rDefault),
  analyze: () => import('./analyze.mjs').then(_rDefault),
  generate: () => import('./generate.mjs').then(_rDefault),
  prepare: () => import('./prepare.mjs').then(_rDefault),
  typecheck: () => import('./typecheck.mjs').then(_rDefault),
  usage: () => import('./usage.mjs').then(_rDefault),
  info: () => import('./info.mjs').then(_rDefault),
  init: () => import('./init.mjs').then(_rDefault),
  create: () => import('./init.mjs').then(_rDefault),
  upgrade: () => import('./upgrade.mjs').then(_rDefault)
};
...
export { commonjsGlobal as a, cyan as b, consola as c, defineNuxtCommand as d, commands as e, showHelp as f, commonjsRequire as g, main as m, showBanner as s };
