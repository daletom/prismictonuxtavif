...
declare type IdentifierMap = Record<string, string>;
declare type Identifiers = [string, string][];
...
declare type _TemplatePlugin = NuxtPlugin & NuxtTemplate;
...
interface ConfigSchema {
  ...
  */
   ...
   * @version 3
  */
  buildModules: (NuxtModule | string)[],
  ...
  */
   ...
   * @default ["/project/node_modules","/home/runner/work/framework/framework/packages/schema/node_modules"]
   * 
   * @example
   * ```js
   * export default {
...
export { AutoImport, AutoImportSource, AutoImportsOptions, Component, ComponentsDir, ComponentsOptions, IdentifierMap, Identifiers, MetaObject, ModuleContainer, ModuleDefinition, ModuleMeta, ModuleOptions, Nuxt, NuxtApp, NuxtCompatibility, NuxtCompatibilityIssue, NuxtCompatibilityIssues, NuxtConfig, _default as NuxtConfigSchema, NuxtHookName, NuxtHooks, NuxtModule, NuxtOptions, NuxtPage, NuxtPlugin, NuxtPluginTemplate, NuxtRoute, NuxtTemplate, PrivateRuntimeConfig, PublicRuntimeConfig, RuntimeConfig, ScanDir, TSReference };
